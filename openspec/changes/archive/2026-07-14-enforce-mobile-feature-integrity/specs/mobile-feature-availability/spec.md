...
- **THEN** fabricated sold counts (e.g. "Da ban 1.2k"), star ratings (e.g. 4.8), verified badges, and time-urgency promotions (e.g. "-25% hom nay") SHALL NOT appear as real ecosystem data
