...
Stabilize the mobile navigation shell so primary and nested navigation surfaces allocate correct layout space, follow the active theme, expose understandable labeled destinations, behave deterministically on entry and reselection, provide visible exit affordances on pushed screens, and remain visually stable during transitions.
