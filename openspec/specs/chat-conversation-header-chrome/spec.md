# chat-conversation-header-chrome Specification

## Purpose
Defines how the Chat conversation screen presents its header chrome by taking over the shared notch band rendered by `ChatTabStack`, instead of rendering a separate stacked header. Created by archiving change fix-chat-header-notch-takeover.
