...
This project is indexed by GitNexus as **koola_app** (12677 symbols, 20799 relationships, 287 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
