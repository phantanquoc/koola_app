...
const makeScreenStyles = (semantic: SemanticTokens) =>
  StyleSheet.create({
    ...
    remoteUserName: { fontSize: 22, fontWeight: 'bold', color: '#fff', marginTop: 16, marginBottom: 8 },
    title: { fontSize: 16, color: '#aaa', marginBottom: 8 },
    statusText: { fontSize: 18, color: '#ccc' },
    failedSection: { alignItems: 'center' },
    failedText: { fontSize: 18, color: semantic.status.danger, fontWeight: '600', marginBottom: 12 },
    retryButton: {
