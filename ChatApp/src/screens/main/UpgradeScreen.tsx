...
const styles = StyleSheet.create({
  ...
  iconWell: { width: 44, height: 44, borderRadius: koolaRadii.pill, alignItems: 'center', justifyContent: 'center' },
  ...
  checkCircle: { width: 22, height: 22, borderRadius: koolaRadii.pill, alignItems: 'center', justifyContent: 'center' },
  checkCircleEmpty: { width: 22, height: 22, borderRadius: koolaRadii.pill, borderWidth: 1.5 },
