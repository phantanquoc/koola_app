...
const makeStyles = (semantic: SemanticTokens) =>
  StyleSheet.create({
    ...
    chip: { flexDirection: 'row', alignItems: 'center', backgroundColor: semantic.action.primarySoft, paddingHorizontal: 8, paddingVertical: 4, borderRadius: koolaRadii.pill, marginRight: 8 },
    ...
    checkBox: { width: 22, height: 22, borderRadius: koolaRadii.pill, borderWidth: 2, borderColor: semantic.border.subtle, alignItems: 'center', justifyContent: 'center' },
