...
This project is indexed by GitNexus as **koola_app** (11061 symbols, 18997 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
